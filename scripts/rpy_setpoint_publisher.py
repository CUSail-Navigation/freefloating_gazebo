...
class Listener:
    def __init__(self):
        ...
        self.setpoint_sub = rospy.Subscriber(
            'body_rpy_setpoint', TwistStamped, self.SetpointCallBack)
...
if __name__ == '__main__':
    ...
    pose_pub = rospy.Publisher(
        'body_position_setpoint', PoseStamped, queue_size=1)
    ...
    while not rospy.is_shutdown():
        if listener.setpoint_received:
            ...
            q = quaternion_from_euler(listener.setpoint.twist.angular.x,
                                      listener.setpoint.twist.angular.y, listener.setpoint.twist.angular.z)
